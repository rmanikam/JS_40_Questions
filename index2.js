...
// console.log(institution['schools'].reverse());

let output = institution["schools"].reverse();
console.log(output);
 console.log(institution['members']);

output.push(institution['members']);
console.log(output);


// let arr = school_institution['schools'].reverse();
